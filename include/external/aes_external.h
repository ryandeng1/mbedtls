#ifndef _AES_EXTERNAL_H_
#define _AES_EXTERNAL_H_
...
public:  
  ...
  void EncryptBlock(const unsigned char in[], unsigned char out[], const unsigned char key[]);
...
void PerformAGMPCAES(unsigned char* key, unsigned char input[16], unsigned output[16]); 
#endif 
